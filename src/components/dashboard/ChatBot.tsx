  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: '1',
      role: 'assistant',
      content: '¡Hola! 👋 Soy tu asistente financiero personal. Estoy aquí para ayudarte con tus finanzas de pareja, presupuestos, objetivos de ahorro y cualquier consulta financiera. ¿En qué puedo ayudarte hoy?',
      timestamp: new Date(),
    }
  ]);

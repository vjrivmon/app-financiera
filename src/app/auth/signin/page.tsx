...
/**
 * Página de inicio de sesión profesional para Budget Couple App
 * Soporta autenticación por email/contraseña y OAuth con Google
 */
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Accede a tu aplicación financiera para parejas
          </p>
        </div>
